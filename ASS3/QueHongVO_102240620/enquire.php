...
<body>
	...
	<div class="bg_img">
	<form  id="regform" class="box" method="post" action="payment.php" >
	    ...
	    <p><label for ="Street_Address"> Street Address* </label>
		        <input type="text" name="Street" id="Street_Address" maxlength="40" required="required"/>
		    
		</p>

		<p><label for = "Suburb/Town"> Suburb/Town* </label>
		        <input type="text" name="Suburb" id="Suburb/Town" maxlength="20" required="required"/>
            ...
            <div class="cart-items">
              <div class = "cart-row">
                <div class="cart-item cart-column">
                    <span class="cart-item-title">Design</span>
              ...
              <div class = "cart-row">
                <div class="cart-item cart-column">
                    <span class="cart-item-title">Computer Science</span>
              ...
              <div class = "cart-row">
                <div class="cart-item cart-column">
                    <span class="cart-item-title">Marketing</span>
              ...
              <div class = "cart-row">
                <div class="cart-item cart-column">
                    <span class="cart-item-title">Business and  Finance</span>
		...
		<!--<p><label for="courses">Courses List </label> 
		...
		<section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Design</span>
                ...
                <div class="shop-item">
                    <span class="shop-item-title">Computer Science</span>
                
                    <div class="shop-item-details">
                        <span class="shop-item-price">$110.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>

                <div class="shop-item">
                    <span class="shop-item-title">Marketing</span>
                ...
                <div class="shop-item">
                    <span class="shop-item-title">Business and Finance </span>
                   
                    <div class="shop-item-details">
                        <span class="shop-item-price">$106.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>
            </div>
        ...
        <section class="container content-section">
            ...
            <button class="btn btn-primary btn-purchase" type="submit"><a href="payment.html" style="text-decoration: none;">PURCHASE</a></button>-->
