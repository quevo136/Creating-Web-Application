...
<body>
	...
	<div class="bg_img">
	<form  id="regform" class="box" method="post" action="payment.php" novalidate="novalidate" >
        ...
        <p><label for="cart-quantity">Quantity*:</label> 
            <input class="cart-quantity-input" name= "Number" id="Number" required="required"/>
