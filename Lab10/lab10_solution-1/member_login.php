...
<meta charset="utf-8" />
<meta name="description" content="Lab 11 - Step 6" />
...
<body>
	...
	<fieldset><legend>Member Log-in</legend>
		<p>	<label for="memId">Member ID: </label>
			<input type="text" name="memId" id="memId" /></p>
...
<?php
	...
	$sql_table="vipmembers";
		...
		$query = "select member_id, fname, lname, email from $sql_table where member_id = $memId and lname= $lname order by lname, fname";
