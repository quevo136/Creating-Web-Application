...
/*function checkName(inputtxt){
    ...
    if (inputtxt.value.match(cardnm)){
        return true;
    }
    else{
...
/*function getBooking(){
    ...
    if(sessionStorage.firstname != undefined){    //if sessionStorage for username is not empty
        ...
        document.getElementById("cart-price cart-header cart-column").textContent = sessionStorage.cartPrice;
        ...
        document.getElementById("cart-total-price").textContent = sessionStorage.cartTotal;
        //fill hidden fields
        ...
        document.getElementById("").value = cost;
    }
...
function storeBooking(cartItem, cartPrice, cartQuantity) {
    sessionStorage.cartItem = cartItem;
    sessionStorage.cartPrice = cartPrice;
...
function prefill_form() {
    if (sessionStorage.firstname != undefined) {
        document.getElementById("cartQuantity").value = sessionStorage.firstname;
